 ...
 * 
 *         I need this factory interface to be able to instantiate generic
 *         ASsToAnalyse inside other classes.
 * 
 * @param <T>
 */
public interface ASsFactory<T extends ASsToAnalyse> {
	public T create(InternetMap iMap, ASsNames names, float visibilityPercent, int threads);
}
